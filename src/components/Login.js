...
// import {
//   getAuth,
//   signInWithPopup,        // Redirect ki jagah Popup use karo - aasaan hai
//   GoogleAuthProvider,
//   onAuthStateChanged
// } from "firebase/auth";
// import { getDatabase, ref, set, get, child } from "firebase/database";
...
//       <form>
//         <h1 className="h3 mb-5 fw-normal text-primary">Log in</h1>
//         <div className="d-flex justify-content-center">
//           <GoogleBtn />
//         </div>
//       </form>
...
//   // onAuthStateChanged sirf ek baar run hoga
//   useEffect(() => {
...
//           if (snapshot.exists()) {
//             // Purana user - seedha dashboard pe bhejo
//             navigate('/user-dashboard');
//           } else {
//             // Naya user - pehle save karo, phir navigate karo
...
//     return () => unsubscribe(); //  Cleanup - memory leak nahi hogi
//   }, []);

//   // ✅ Redirect ki jagah Popup use karo
//   async function SignInGoogle() {
//     const provider = new GoogleAuthProvider();
//     setLoading(true);
//     try {
//       await signInWithPopup(auth, provider);
//       // onAuthStateChanged khud handle karega navigate karna
//     } catch (error) {
...
//         disabled={loading}  // Double click se bachao
//       >
//         <div className="bg-light p-2 rounded-start">
//           <img width="40px" src="/logo1.png" alt="Google" />
//         </div>
//         <div className="ms-2">
